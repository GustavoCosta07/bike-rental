...
namespace BikeRental.Infrastructure.Migrations
{
    ...
    [Migration("20250425144713_FixDateTimeHandlingV2")]
    partial class FixDateTimeHandlingV2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BikeRental.Domain.Entities.Rental", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ExpectedEndDate = new DateTime(2024, 1, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
